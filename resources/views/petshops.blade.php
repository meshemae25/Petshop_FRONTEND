        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 fade-in-up">
                    <h1 class="display-4">{{ $hero_title ?? 'Everything Your Pet Needs,<br>Just a Click Away!' }}</h1>
                    ...
                    <div class="d-grid gap-3 d-md-flex">
                        ...
                        <a href="{{ route('loyalty') }}" class="btn btn-outline-primary px-4 py-2">Join Our Pack</a>
                    </div>
                </div>
            ...
            <div class="row category-row g-4 justify-content-center">
                ...
                @if(empty($categories))
                    <div class="col category-col">
                        <div class="category-item text-center">
                            <div class="icon-bg">
                                <img src="{{ asset('images/toys-icon.png') }}" alt="Toys & Treats" class="category-icon">
                            </div>
                    ...
                    <div class="col category-col">
                        <div class="category-item text-center">
                            <div class="icon-bg">
                                <img src="{{ asset('images/time-icon.png') }}" alt="Time & Training" class="category-icon">
                            </div>
                    ...
                    <div class="col category-col">
                        <div class="category-item text-center">
                            <div class="icon-bg">
                                <img src="{{ asset('images/travel-icon.png') }}" alt="Travel & Transit" class="category-icon">
                            </div>
                    ...
                    <div class="col category-col">
                        <div class="category-item text-center">
                            <div class="icon-bg">
                                <img src="{{ asset('images/tags-icon.png') }}" alt="Tags & Tracking" class="category-icon">
                            </div>
                    ...
                    <div class="col category-col">
                        <div class="category-item text-center">
                            <div class="icon-bg">
                                <img src="{{ asset('images/health-icon.png') }}" alt="Health & Hygiene" class="category-icon">
                            </div>
                        ...
                        @empty
                            <div class="col-md-4">
                                <div class="card product-card h-100">
                                    ...
                                    <div class="overflow-hidden">
                                        <img src="{{ asset('images/dog-food.jpg') }}" class="card-img-top" alt="Premium Dog Food">
                                    </div>
                                    <div class="card-body d-flex flex-column">
                            ...
                            <div class="col-md-4">
                                <div class="card product-card h-100">
                                    ...
                                    <div class="overflow-hidden">
                                        <img src="{{ asset('images/cat-tree.jpg') }}" class="card-img-top" alt="Deluxe Cat Tree">
                                    </div>
                                    <div class="card-body d-flex flex-column">
                            ...
                            <div class="col-md-4">
                                <div class="card product-card h-100">
                                    ...
                                    <div class="overflow-hidden">
                                        <img src="{{ asset('images/pet-collar.jpg') }}" class="card-img-top" alt="Smart Pet Collar">
                                    </div>
                                    <div class="card-body d-flex flex-column">
    ...
    <section class="partners-section py-5">
        <div class="container">
            ...
            <div class="row align-items-center justify-content-center g-4">
                ...
                <div class="col-4 col-md-2 text-center">
                    <img src="{{ asset('images/partner2.png') }}" alt="Partner Brand" class="img-fluid partner-logo">
                </div>
                <div class="col-4 col-md-2 text-center">
                    <img src="{{ asset('images/partner3.png') }}" alt="Partner Brand" class="img-fluid partner-logo">
                </div>
                <div class="col-4 col-md-2 text-center">
                    <img src="{{ asset('images/partner4.png') }}" alt="Partner Brand" class="img-fluid partner-logo">
                </div>
                <div class="col-4 col-md-2 text-center">
                    <img src="{{ asset('images/partner5.png') }}" alt="Partner Brand" class="img-fluid partner-logo">
                </div>
                <div class="col-4 col-md-2 text-center">
                    <img src="{{ asset('images/partner6.png') }}" alt="Partner Brand" class="img-fluid partner-logo">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="testimonial-card">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="avatar">
                                <img src="{{ asset('images/customer1.jpg') }}" alt="Customer">
                            </div>
                ...
                <div class="col-md-4">
                    <div class="testimonial-card">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="avatar">
                                <img src="{{ asset('images/customer2.jpg') }}" alt="Customer">
                            </div>
                            <div class="customer-info">
                ...
                <div class="col-md-4">
                    <div class="testimonial-card">
                        <p class="testimonial-text">The customer service at PawShop is unmatched. When I needed help selecting the right food for my rabbit's dietary needs, they went above and beyond.</p>
                        <div class="d-flex align-items-center">
                            <div class="avatar">
                                <img src="{{ asset('images/customer3.jpg') }}" alt="Customer">
                            </div>
                            <div class="customer-info">
                                <h6 class="customer-name">Sophia R.</h6>
                                <p class="customer-type">Rabbit Parent</p>
                            </div>
                            <div class="rating ms-auto">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="section-subtitle mb-4">Subscribe to get exclusive offers, pet care tips, and more</p>
                    <div class="row justify-content-center">
                        <div class="col-md-8">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="footer-widget">
                        <img src="{{ asset('images/pawshop-logo-white.png') }}" alt="PawShop Logo" height="40" class="mb-4">
                ...
                <div class="col-lg-2 col-md-6">
                    <div class="footer-widget">
                        ...
                        <ul class="list-unstyled footer-links">
                            ...
                            <li><a href="{{ route('category', 'birds') }}">Birds</a></li>
                            <li><a href="{{ route('category', 'small-pets') }}">Small Pets</a></li>
                            <li><a href="{{ route('category', 'fish') }}">Fish</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="footer-widget">
                        ...
                        <div class="d-flex mt-3">
                            ...
                            <img src="{{ asset('images/amex.png') }}" alt="American Express" class="payment-icon">
